                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel class="product-thumbs-track ps-slider" :loop="true" :dots="false" :items="3" :nav="false" :autoplay="true">
...
import RelatedProductOlshop from '@/components/RelatedProductOlshop.vue';
